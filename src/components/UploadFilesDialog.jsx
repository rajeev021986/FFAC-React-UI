...
export default function UploadFilesDialog({
    dialogOpen, handleDialogClose, dropdownData, formData, handleInputChange, formErrors, sourceType, handleDialogSave, openConfirmation, onCloseConfiramtion, deleteData, onDelete, viewDialogOpen, handleViewDialogClose, viewDocument, fileData
}) {
                        ...
                        {typeField ?
                            ...
                            <Grid item xs={12}>
                                <SelectBox
                                    label="Document Type"
                                    id="documentType"
                                    options={[...dropdownData, { value: "Other" }]}
                                    value={formData.documentType}
                                    onChange={(e) => {
                                        handleInputChange(e);
