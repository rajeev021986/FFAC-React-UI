...
import { updateDsoOrderListInput } from "../../../store/freatures/DsoOrderListSlice";

export default function DsoOrderListSearchForm() {
  const dispatch = useDispatch();
  const inputs = useSelector((state) => state.dsoOrderList.formData);
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(updateDsoOrderListInput(values));
    },
  });
  const handleReset = () => {
    formik.resetForm();
