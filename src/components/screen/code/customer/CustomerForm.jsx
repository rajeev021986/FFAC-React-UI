            ...
            <Grid container spacing={2}>
              ...
              >
                <SelectBox
                  ...
                  value={formik.values.status} // customer === 'new' ? new : formik.values.status
              ...
              {page == "customer" && (
                <Grid item xs={12}>
                  <Stack direction="row" spacing={2}>
                    <OutlinedButton
                      sx={{ fontWeight: "500", borderRadius: "12px" }} // Added borderRadius here
                    >
                      Cancel
                    </OutlinedButton>
                    <ThemeButton
                      onClick={formik.handleSubmit}
                      sx={{ fontWeight: "500", borderRadius: "12px" }} // You can add borderRadius here as well if needed
                    >
                      {isLoading && (
