...
export default function FormatForm({ selectedListItem }) {
  ...
  const [updateFormat, { isLoading: isLoading }] = useUpdateFormatMutation();
  const [formattedValue, setFormattedValue] = useState(selectedListItem.value);
    ...
    <Box width="40%">
      <Stack spacing={2} width="500px">
        ...
        <FormGroup>
          ...
          <Divider>
            <small>Additional Settings</small>
          </Divider>
        ...
        <Stack direction="row" spacing={2} mt={5} justifyContent={"start"}>
          <OutlinedButton size="small" onClick={handleReset}>
            Reset
          </OutlinedButton>
