  ...
  endpoints: (builder) => ({
    ...
    fetchSPRBLPackingList: builder.query({
      query: (params) => {
        const queryString = new URLSearchParams(params).toString();
        return {
          url: `/packing_listSPRBL?${queryString}`,
          method: "GET",
          headers: getAppHeaders(),
        };
      },
