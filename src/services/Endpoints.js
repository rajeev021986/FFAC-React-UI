const ENDPOINTS = {
  ...
  GET_SHIPPER_AUDIT: (id) => `/master-service/v1/shipper/audit/${id}`,
  GET_CONSIGNEE_AUDIT: (id) => `/master-service/v1/consignee/audit/${id}`,
  ...
  GET_SHIPPER_DETAILS: (id) => `/master-service/v1/shipper/${id}`,
  GET_CONSIGNEE_DETAILS: (id) => `/master-service/v1/consignee/${id}`,
